...
public class Owner_Login extends AppCompatActivity {
    ...
    private void userLogin() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ServerData.OwnerLogin, new Response.Listener<String>() {

            @Override
            public void onResponse(String response) {
                if (response.trim().equals("success")) {
                    Toast.makeText(Owner_Login.this, "Success", Toast.LENGTH_SHORT).show();
                    //  finish();
                    //  progress.hide();
                } else {
                    Toast.makeText(Owner_Login.this, response, Toast.LENGTH_LONG).show();
                }
            }
        },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Owner_Login.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
